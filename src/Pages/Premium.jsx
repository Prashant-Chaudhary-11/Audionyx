...
export const Premium = () => {
    const plans = [
        {
            name: "Family",
            desc: "6 premium account, cancel everytime",
            price: "INR800.00",
            btnColor: "custom-btn",
            features: [
                "6 Premium accounts",
        ...
        {
            name: "Individual",
            desc: "1 premium account, cancel everytime",
            price: "INR540.00",
                                    ...
                                    <div className={`flip-card-front premium_card_${index} card plan-card border-0`}>
                                        <div className="card-body d-flex flex-column justify-content-between">
                                            <div className="text-start">
                                                ...
                                                <p className="">{plan.desc}</p>
                                            </div>
                                            <div>
                                                <div className="mb-3 d-flex align-items-center">
                                                    <h2 className="fw-bold m-0">{plan.price}</h2>
                                                    <span className="fs-6">/month</span>
                                                </div>
                                                <span className="position-absolute bottom-0 end-0 premium_circle p-3 rounded-circle d-flex align-items-center justify-content-center"><i class="lni lni-arrow-angular-top-right"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="card-body text-start">
                                            ...
                                            <ul className="list-unstyled">
                                                {plan.features.map((feature, i) => (
                                                    <li className="mb-2" key={i}><svg className="me-2" width="20" height="20" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0 0 0)">
